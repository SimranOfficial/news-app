      ...
      <div className="container py-3">
        ...
        <div className="col-md">
            <div className="d-flex align-items-center" style={{fontSize: '20px', fontWeight: '500'}}>
              <img src={logo} alt="NewsApp" style={{width: '42px', marginRight: '10px'}} /> {props.brandName}
            </div> 
            <p>Get all the latest news at one place, just a touch away!</p>
            <p>Copyright &copy; 2023 NewsApp</p>
            <p>Developed By <a className="pointer text-decoration-none text-light footer-link" href="/" target="_blank" rel="noreferrer">Simran</a></p>
          </div>
